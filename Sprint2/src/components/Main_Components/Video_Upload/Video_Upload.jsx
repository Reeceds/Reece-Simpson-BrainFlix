        ...
        <section className="upload-video-section__container site__container"> 
            ...
            <form className="upload-video-form">
                <div className="upload-video-form-image__container">
                    ...
                    <input className="upload-video-input" type="text" placeholder="Add a title to your video"/>
                    <h5 className="upload-video-form__title">ADD A VIDEO DESCRIPTION</h5>
                    <textarea className="upload-video-input upload-video-input__description" placeholder="Add a description of your video"/>
                    </div>
                </div>
